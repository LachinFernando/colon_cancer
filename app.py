...
PREDICTED_LABELS = ['normal', 'ulcerative colitis', 'polyps', 'esophagitis']
PREDICTED_LABELS.sort()


def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/0ad25c0b-e9d7-47b9-a5fb-5a0ad005cfc2'
...
st.title("Colon Image Classifier")#change according to your project
